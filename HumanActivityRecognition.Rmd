...
We conclude that the combined model performs exactly like the random forest model. Therefore, we construct predictions for the test data set with the random forest model alone.
